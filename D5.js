...
/*
cars[0].licensePlate = "KJ023ML"
cars[1].licensePlate = "CS657RP"
cars[2].licensePlate = "FD229AZ"
console.log(cars)
*/
/* ESERCIZIO 6
...
let i = 0
while(i<1){
  let x = numericArray.indexOf(66);
  (numericArray.length = x);
